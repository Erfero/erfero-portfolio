...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    authorRole: { fr: "Fondatrice, marque cosmétique", en: "Founder, cosmetics brand" },
    quote: {
      fr: "La boutique tourne vraiment bien, mes premières ventes sont arrivées dès la première semaine 🎉",
      en: "The store is really performing, my first sales came in during the very first week 🎉",
    },
    accent: "#25D366",
  },
  {
    id: "t22",
    type: "instagram",
    authorName: "hugo.dropship",
    quote: {
      fr: "Rapide, sérieux, et le résultat dépasse largement ce que j'imaginais pour ce budget.",
      en: "Fast, serious, and the result is well beyond what I expected for this budget.",
    },
    rating: 5,
    accent: "#E1306C",
  },
  {
    id: "t23",
    type: "delivery",
    authorName: "Kyra Cosmetic",
    quote: {
      fr: "Boutique en ligne et testée avant transfert, aucun bug relevé.",
      en: "Store live and tested before handover, no bugs found.",
    },
    accent: "#E8DCC0",
  },
  {
    ...
    authorRole: { fr: "Gérant, boutique tech", en: "Owner, tech store" },
    quote: {
      fr: "On a eu un petit délai sur la livraison finale mais le résultat valait l'attente.",
      en: "We had a small delay on final delivery but the result was worth the wait.",
    },
    rating: 4,
    accent: "#25D366",
  },
  {
    ...
    authorRole: { fr: "Paris, France", en: "Paris, France" },
    quote: {
      fr: "Deuxième projet confié cette année, toujours la même rigueur.",
      en: "Second project we've handed him this year, same rigor every time.",
    },
    rating: 5,
    accent: "#E8D8B8",
  },
  {
    id: "t26",
    type: "instagram",
    authorName: "leila.beautystore",
    quote: {
      fr: "Design nickel, mes clientes adorent le nouveau site.",
      en: "Clean design, my customers love the new site.",
    },
    rating: 5,
    accent: "#E1306C",
  },
  {
    ...
    type: "whatsapp",
    authorName: "Marc",
    authorRole: { fr: "Fondateur, marque outdoor", en: "Founder, outdoor brand" },
    quote: {
      fr: "Bonne écoute sur les retouches demandées, tout a été ajusté sans discussion.",
      en: "Good listening on the requested tweaks, everything was adjusted without a fuss.",
    },
    rating: 4,
    accent: "#25D366",
  },
  {
    ...
    authorName: "Velora",
    quote: {
      fr: "Refonte complète mise en ligne, tunnel de vente validé avant transfert.",
      en: "Full redesign shipped, sales funnel approved before handover.",
    },
    accent: "#D8D0C8",
  },
  {
    ...
    authorRole: { fr: "Bordeaux, France", en: "Bordeaux, France" },
    quote: {
      fr: "Communication claire à chaque étape, on sait toujours où en est le projet.",
      en: "Clear communication at every step, we always know where the project stands.",
    },
    rating: 5,
    accent: "#B9FF5C",
  },
  {
    id: "t30",
    type: "instagram",
    authorName: "sam.wellnessco",
    quote: {
      fr: "Site rapide, propre, exactement ce qu'on avait demandé.",
      en: "Fast, clean site, exactly what we asked for.",
    },
    rating: 5,
    accent: "#E1306C",
  },
